...
from app.schemas.auth import UserCreate, UserOut, Token, TokenRefresh, Error, Success
...
# @router.post("/token", response_model=Success | Error)
...
# @router.post("/refresh-token", response_model=Success | Error)
